...
public class ESTnFIN {
    public static void main(String[] args) throws InterruptedException {
        System.setProperty("webdriver.chrome.driver","D:\\chromedriver.exe");

        String[] countryArray = {" Finland"};

        String[] countryWithCode = {"EST: Estonia", "FIN: Finland"};
...
//        WebDriver driver = new ChromeDriver();
            ...
            try{
                ...
                System.out.println("Setting Reporting Country");
                ...
                System.out.println("Setting Reporting Country successful");
                ...
                System.out.println("Getting Partner Country List");
                ...
                System.out.println("Partner Country List "+partnerCountryList.size());
                    ...
                    if (partnerCountryList2.get(ab).getText().trim().equals( countryWithCode[a].trim() ))
                    {
                        ...
                        if (opts.size() > 0)
                        {
                            for (int l = 0; l < opts.size(); l++) {
                                if (countryArray[a].trim().equals("Australia") && l==0)
                                {
                                    l = 95;
                                }
                                try {
