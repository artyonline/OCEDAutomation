...
public class PRTnSVK {
    public static void main(String[] args) throws InterruptedException {
        System.setProperty("webdriver.chrome.driver","D:\\chromedriver.exe");

        String[] countryArray = {" Portugal", " Slovak Republic"};

        String[] countryWithCode = {"PRT: Portugal123", "SVK: Slovak Republic"};
            ...
            try{
                ...
                for (int ab = 0; ab< partnerCountryList.size(); ab++)
                {
                    ...
                    if (partnerCountryList2.get(ab).getText().trim().equals( countryWithCode[a].trim()))
                    {
                        ...
                        if (opts.size() > 0)
                        {
                            for (int l =91; l < opts.size(); l++) {
//                                if (countryArray[a].trim().equals("Portugal") && l==0)
//                                {
//                                    l = 91;
//                                }
                                try {
